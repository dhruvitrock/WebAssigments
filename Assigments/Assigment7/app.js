...
function background(input) {
    if (input === "Clear")
        ...
        $("body").css("background-image", "url('https://images.unsplash.com/photo-1545163448-d4de96e7447e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=750&q=80')");
        ...
        $("body").css("background-image", "url('https://images.unsplash.com/photo-1470217957101-da7150b9b681?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80')");
}
